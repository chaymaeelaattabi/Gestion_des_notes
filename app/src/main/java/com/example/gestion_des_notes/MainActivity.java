...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //remplir la Liste déroulante(pinner)utilisant un arrayAdapter
    ...
    //la fonction addItem est utilisée pour ajouter la note et le module au ListView
    ...
    public boolean existe(ArrayList<String> ModuleExiste, String val){
        ...
        for(int i = 0 ; i<ModuleExiste.size();i++){
            //La méthode equals() de la classe String teste l'égalité des valeurs
            // et retourne true si les deux chaines de caractères contiennent les mêmes caractères
